...
export default function IndexPage() {
  ...
  return (
    <>
      ...
      {/* SECCIÓN INICIO */}
      <section id="inicio" aria-labelledby="innovacion-tecnologica-heading">
        <div className="flex flex-col gap-5 lg:w-4/5 mx-auto p-5 pt-10 pb-30 md:pt-25">
          <h2 id="innovacion-tecnologica-heading" className="text-2xl font-semibold md:text-4xl md:w-2/3 lg:text-5xl lg:text-neutral-800 lg:w-3/4">
            <span className="text-orange-600">Innovación</span> tecnologica para empresas que lideran su industria.
          </h2>
      ...
      {/* SECCIÓN CONTACTO */}
      <section className="w-6/7 mx-auto" id="contacto" style={{ backgroundColor: 'yellow' }}>
        <Contacto />
      </section>

      {/* SECCIÓN DESARROLLO DE PROYECTOS */}
      <section id="desarrollo-proyectos" aria-labelledby="soluciones-heading">
        <div className="flex flex-col gap-5 lg:w-4/5 mx-auto p-5 md:pt-25">
          <h2 id="soluciones-heading" className="text-2xl font-semibold md:text-4xl md:w-2/3 lg:text-5xl lg:text-neutral-800 lg:w-3/4">
            <span className="text-orange-600">Proyectos </span>que generan confianza y resultados
          </h2>
          <p className="md:w-2/3 lg:text-2xl lg:w-3/4 text-neutral-600">
            Explora nuestras soluciones clave, donde convergen innovación, experiencia y resultados excepcionales.
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10">
            {/* Motion articles con imágenes intactas */}
            <motion.article
              initial={{ opacity: 0 }}
            ...
            >
              <div className="w-full aspect-square overflow-hidden rounded-lg">
                <img src="/img/gestion-agil.jpg" alt="Gestión Ágil" className="w-full h-full object-cover" />
              </div>
            ...
            >
              ...
              <h3 className="text-xl font-bold">Digitalización.</h3>
            ...
            >
              ...
              <h3 className="text-xl font-bold">Crecimiento Empresarial.</h3>
      ...
      {/* SECCIÓN FORMACIÓN */}
      <section id="formacion" aria-labelledby="capacitacion-tecnologica-heading" className="min-h-screen flex items-center justify-center">
        <div className="flex flex-col gap-5 lg:w-4/5 mx-auto mb-5 p-5 pb-25 md:pt-25">
          <h2 id="capacitacion-tecnologica-heading" className="text-2xl font-semibold md:text-4xl md:w-2/3 lg:text-5xl lg:text-neutral-800 lg:w-3/4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-11/12 md:w-4/5 mx-auto mt-10">
            {/* Todas las tarjetas de formación intactas */}
            <article>
              <a href="https://www.awsacademy.com/login?ec=302&startURL=%2FSiteLogin%3FstartURL%3D%252Fforums%252F" target="_blank" rel="noopener noreferrer" className="block">
                <motion.div
                  initial={{ y: 40, opacity: 0.8 }}
                  whileInView={{ y: 0, opacity: 1 }}
                  viewport={{ once: true, amount: 0.4 }}
                  transition={{ type: "spring", damping: 5, stiffness: 100, mass: 0.4, delay: 0.2 }}
                  className="cursor-pointer flex flex-col justify-center border border-neutral-400 rounded-lg px-6 py-6 shadow-lg shadow-neutral-400 bg-[#FF9900] hover:scale-105 transition-transform duration-300"
                >
            ...
            <article>
              <a href="https://www.udemy.com/" target="_blank" rel="noopener noreferrer" className="block">
                <motion.div
                  ...
                  className="cursor-pointer flex flex-col justify-center border border-neutral-400 rounded-lg px-6 py-6 shadow-lg shadow-neutral-400 bg-[#EC5252] hover:scale-105 transition-transform duration-300"
                >
            ...
            <article>
              <a href="https://www.edx.org/learn/python" target="_blank" rel="noopener noreferrer" className="block">
                <motion.div
                  ...
                  className="cursor-pointer flex flex-col justify-center items-start border border-neutral-400 rounded-lg px-6 py-6 shadow-lg shadow-neutral-400 bg-[#306998] hover:scale-105 transition-transform duration-300"
                >
            ...
            <article>
              <a href="https://logaligroup.com/cursos-gratis-aprender-sap-desde-cero/" target="_blank" rel="noopener noreferrer" className="block">
                <motion.div
                  initial={{ y: 40, opacity: 0.2 }}
                  whileInView={{ y: 0, opacity: 1 }}
                  viewport={{ once: true, amount: 0.4 }}
                  transition={{ type: "spring", damping: 5, stiffness: 100, mass: 0.4, delay: 0.8 }}
                  className="cursor-pointer flex flex-col justify-center items-start border border-neutral-400 rounded-lg px-6 py-6 shadow-lg shadow-neutral-400 bg-[#1E7145] hover:scale-105 transition-transform duration-300"
                >
