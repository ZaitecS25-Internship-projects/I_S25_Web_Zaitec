...
export default function IndexPage() {
  ...
  return (
    <>
      ...
      {/* Sección Contacto */}
      <section id="contacto" className="w-6/7 mx-auto bg-yellow-300 mb-20">
        <Contacto />
      </section>
      ...
      <section aria-labelledby="innovacion-tecnologica-heading">
        <div className="flex flex-col gap-5 lg:w-4/5 mx-auto p-5 pt-10 pb-30 md:pt-25">
          <h2
            ...
            className="text-2xl font-semibold md:text-4xl lg:text-5xl text-neutral-800 lg:w-3/4"
          >
      ...
      <section className="bg-neutral-100 min-h-screen flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col gap-10 lg:w-4/5 mx-auto mb-20">
          {trainingCards.map((card, index) => (
            <div
              key={index}
              className="w-full bg-white rounded-xl shadow-md p-6"
            >
              <CardFormacion card={card} index={index} />
            </div>
          ))}
        </div>
      </section>
