...
export default function IndexPage() {
  ...
  return (
    <>
      <div className="bg-neutral-100 shadow-sm shadow-neutral-400">
        <section className="flex flex-col gap-5 lg:w-4/5 mx-auto p-5 pt-10 pb-30 md:pt-25  ">
      ...
      <div>
        <section>
          <div className="">
            <section className="flex flex-col gap-5 lg:w-4/5 mx-auto p-5 md:pt-25 ">
      ...
      <div className="min-h-screen flex items-center justify-center">
        <section className="flex flex-col gap-5 lg:w-4/5 mx-auto mb-5 p-5 pb-25 md:pt-25">
