      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between gap-12">
        ...
        <div className="flex flex-col gap-2">
          ...
          <ul className="flex flex-col gap-1 text-sm">
            <li>
              <a href="#inicio" className="hover:text-orange-500 transition duration-300 ease-in-out transform hover:translate-x-1">
                Inicio
              </a>
            </li>
            <li>
              <a href="#contacto" className="hover:text-orange-500 transition duration-300 ease-in-out transform hover:translate-x-1">
                Contacto
              </a>
            </li>
            <li>
              <a href="#formacion" className="hover:text-orange-500 transition duration-300 ease-in-out transform hover:translate-x-1">
                Formación
              </a>
            </li>
            <li>
              <a href="#desarrollo-proyectos" className="hover:text-orange-500 transition duration-300 ease-in-out transform hover:translate-x-1">
